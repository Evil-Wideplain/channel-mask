...
def prep_domains_shar_random_fine(args, SLIDING_WINDOW_LEN=0, SLIDING_WINDOW_STEP=0):
    # note: for SHAR dataset, the following domains have incomplete classes: 4, 7, 8, 10, 12, 18, 26, 27, 28, 30
...
def prep_shar(args, SLIDING_WINDOW_LEN=0, SLIDING_WINDOW_STEP=0):
    if args.cases == 'subject':
        ...
        return prep_domains_shar_random_fine(args, SLIDING_WINDOW_LEN, SLIDING_WINDOW_STEP)
    elif args.cases == '':
        pass
    else:
        return 'Error!\n'
